...
canvas.create_image(410,6, anchor=NW, image=piezza12, tags="img")
canvas.create_image(410,166, anchor=NW, image=piezza13, tags="img")
canvas.create_image(410,332, anchor=NW, image=piezza14, tags="img")
canvas.create_image(410,492, anchor=NW, image=piezza15, tags="img")
canvas.create_image(490,86, anchor=NW, image=piezza16, tags="img")
canvas.create_image(490,246, anchor=NW, image=piezza17, tags="img")
canvas.create_image(490,406, anchor=NW, image=piezza18, tags="img")
canvas.create_image(490,566, anchor=NW, image=piezza19, tags="img")
canvas.create_image(570,6, anchor=NW, image=piezza20, tags="img")
canvas.create_image(570,166, anchor=NW, image=piezza21, tags="img")
canvas.create_image(570,332, anchor=NW, image=piezza22, tags="img")
canvas.create_image(570,492, anchor=NW, image=piezza23, tags="img")
